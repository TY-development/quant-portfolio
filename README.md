# Quant Portfolio – Taiga Yamauchi

A curated collection of my quantitative research projects, machine learning
experiments, time-series studies, and infrastructure tools.  
This repository represents my core work for systematic trading, predictive modeling,
and data-driven market research.
...
systematic investing and quantitative analysis.
...
## 🧠 Technical Skills
**Programming:** Python, NumPy, pandas, scikit-learn, statsmodels, LightGBM  
**Quant:** Feature engineering, time-series modeling, event studies, factor research  
**Math:** Probability, statistics, linear algebra, regression, optimization  
**Infra:** Docker, AWS (Lambda/ECS), Git, Jupyter
...
- Statistical modeling & signal construction  
